...
?>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/page_dash/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/page_dash/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/page_dash/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/page_dash/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>/assets/page_dash/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
  ...
  <header class="main-header" >
   <?php 
        ...
        foreach ($collect_data as $values) {
            ...
            $logo =$values->Logo;                        
    ?>
    <a href="<?php echo base_url(); ?>dashboard/AdminDash/index/<?php echo $portal_ID; ?>" class="logo" style="background: #800000;">
      <span class="logo-mini" ><img src="<?php echo base_url(); ?>/assets/img/<?php echo $logo; ?>"></span>
      <span class="logo-lg"><b><?php echo $alias."-";?></b>Admin</span>
    </a>
  <?php }} ?>
