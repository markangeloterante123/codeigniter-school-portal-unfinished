...
?>
  ...
  <title>myPORTAL Registrar</title>
...
<div class="wrapper" >
  <header class="main-header" >
    ...
    <a href="<?php echo base_url(); ?>dashboard/SuperDash/index/<?php echo $portal_ID; ?>" class="logo" style="background: #800000;">
      <span class="logo-mini" ><img src="<?php echo base_url(); ?>/assets/img/<?php echo $logo; ?>"></span>
      <span class="logo-lg"><b><?php echo $alias." - "; ?></b>Registrar</span>
    </a>
  <?php }} ?>
