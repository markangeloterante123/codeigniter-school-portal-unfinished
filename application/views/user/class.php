...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        Proffessor: Prof. <?php echo $prof; ?>
      <?php }} ?>
        
        <input type="hidden" name="admin_id" value="<?php echo $student_id; ?>">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <hr>
                ...
                <table>
                  <tbody class="ajax_display_activity_complished">
                    
                  </tbody>
                </table>
              
              <div class="ajax_student_offline">
              ...
              <div class="tab-pane" id="settings">
                ...
                <div  class="box box-success">
                  <div class="box-header">
                    ...
                    <h3 class="box-title">Class Chat Box</h3>
                  </div>
                  ...
                  <div class="box-footer">
                    <div class="input-group">
                      ...
                      <div class="input-group-btn">
                        <button type="submit" class="btn btn-success sent"><i class="fa fa-send"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Submit Files</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <form action="<?php echo base_url(); ?>pages/portal_student_upload/<?php echo $name; ?>/<?php echo $student_id; ?>" method="post" enctype="multipart/form-data" id=>
          <div class="modal-body">
